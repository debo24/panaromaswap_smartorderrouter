...
import { Protocol, SwapRouter } from 'panaromaswap_routersdk';
import { Fraction, Percent, TradeType } from 'panaromaswap_sdkcore';
import { Pair } from 'panaromaswap_v2sdk';
import { encodeSqrtRatioX96, Pool, Position } from 'panaromaswap_v3sdk';
...
describe('alpha router', () => {
  ...
  let mockMulticallProvider: sinon.SinonStubbedInstance<PanaromaswapMulticallProvider>;
  ...
  const SWAP_AND_ADD_OPTIONS: SwapAndAddOptions = {
    ...
    swapOptions: {
      deadline: 100,
      recipient: '0x4fFDD5Cf5f16D93d481CEDb70A1cBE37c3AaD329',
  ...
  beforeEach(() => {
    ...
    mockMulticallProvider = sinon.createStubInstance(PanaromaswapMulticallProvider);
