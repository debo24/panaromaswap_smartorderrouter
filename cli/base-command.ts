...
import { Currency, CurrencyAmount, Token } from 'panaromaswap_sdkcore';
...
export abstract class BaseCommand extends Command {
  ...
  private _multicall2Provider: PanaromaswapMulticallProvider | null = null;
  ...
  async init() {
    ...
    this._log = bunyan.createLogger({
      name: 'Panaromaswap Smart Order Router',
    ...
    const multicall2Provider = new PanaromaswapMulticallProvider(chainId, provider);
