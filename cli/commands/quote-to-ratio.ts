...
import { Currency, Ether, Fraction, Percent } from 'panaromaswap_sdkcore';
import { Position } from 'panaromaswap_v3sdk';
...
export class QuoteToRatio extends BaseCommand {
  static description = 'Panaromaswap Smart Order Router CLI';
