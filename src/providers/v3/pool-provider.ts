...
import { computePoolAddress, FeeAmount, Pool } from 'panaromaswap_v3sdk';
import retry, { Options as RetryOptions } from 'async-retry';
import _ from 'lodash';

import { IPanaromaswapV3PoolState__factory } from '../../types/v3/factories/IPanaromaswapV3PoolState__factory';
  ...
  private async getPoolsData<TReturn>(
    ...
    const { results, blockNumber } = await retry(async () => {
      ...
      >({
        ...
        contractInterface: IPanaromaswapV3PoolState__factory.createInterface(),
