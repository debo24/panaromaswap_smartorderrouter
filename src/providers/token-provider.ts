...
export const BANG_MAINNET = new Token(
  ChainId.MAINNET,
  '0x3AE14c96e3A479DAc97984eD3829cfA23364e517',
  18,
  'BANG',
  'Panaromaswap'
);
...
export const BANG_GÖRLI = new Token(
  ChainId.GÖRLI,
  '0x3AE14c96e3A479DAc97984eD3829cfA23364e517',
  18,
  'BANG',
...
export const BANG_ARBITRUM_RINKEBY = new Token(
  ChainId.ARBITRUM_RINKEBY,
