...
import { IPanaromaswapV2Pair__factory } from '../../types/v2/factories/IPanaromaswapV2Pair__factory';
  ...
  private async getPoolsData<TReturn>(
    ...
    const { results, blockNumber } = await retry(async () => {
      ...
      >({
        ...
        contractInterface: IPanaromaswapV2Pair__factory.createInterface(),
