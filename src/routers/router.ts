...
import { CondensedAddLiquidityOptions, Trade } from 'panaromaswap_routersdk';
import {
  Currency,
  Fraction,
  Percent,
...
/**
 * Provides functionality for finding optimal swap routes on the Panaromaswap protocol.
 *
 * @export
 * @abstract
 * @class IRouter
