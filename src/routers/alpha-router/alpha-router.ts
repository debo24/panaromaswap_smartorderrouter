...
import DEFAULT_TOKEN_LIST from 'panaromaswap_defaulttokenlist';
import { Protocol, SwapRouter, Trade } from 'panaromaswap_routersdk';
import { Currency, Fraction, Token, TradeType } from 'panaromaswap_sdkcore';
import { TokenList } from 'panaromaswap_tokenlists';
import { Pair } from 'panaromaswap_v2sdk';
import {
  MethodParameters,
  Pool,
  Position,
...
export type AlphaRouterParams = {
   ...
   */
  multicall2Provider?: PanaromaswapMulticallProvider;
  /**
   ...
   * Defaults to Panaromaswap's unsupported token list.
   */
...
export type ProtocolPoolSelection = {
   ...
   * This is similar to how the legacy routing algorithm used by Panaromaswap would select
    ...
    ISwapToRatio<AlphaRouterConfig, SwapAndAddConfig>
{
  ...
  protected multicall2Provider: PanaromaswapMulticallProvider;
  ...
  constructor({
    ...
    this.multicall2Provider =
      multicall2Provider ??
      new PanaromaswapMulticallProvider(chainId, provider, 375_000);
    this.v3PoolProvider =
      v3PoolProvider ??
    ...
    // ipfs urls in the following format: `https://cloudflare-ipfs.com/ipns/api.panaromaswap.org/v1/pools/${protocol}/${chainName}.json`;
      ...
      this.v2SubgraphProvider = new V2SubgraphProviderWithFallBacks([
        new CachingV2SubgraphProvider(
          ...
          new URISubgraphProvider(
            chainId,
            `https://cloudflare-ipfs.com/ipns/api.panaromaswap.org/v1/pools/v2/${chainName}.json`,
            undefined,
            0
          ),
    ...
    if (v3SubgraphProvider) {
      ...
      this.v3SubgraphProvider = new V3SubgraphProviderWithFallBacks([
        new CachingV3SubgraphProvider(
          ...
          new URISubgraphProvider(
            chainId,
            `https://cloudflare-ipfs.com/ipns/api.panaromaswap.org/v1/pools/v3/${chainName}.json`,
            undefined,
            0
          ),
          new NodeJSCache(new NodeCache({ stdTTL: 300, useClones: false }))
