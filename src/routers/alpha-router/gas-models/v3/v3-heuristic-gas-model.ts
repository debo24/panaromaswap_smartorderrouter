...
import { Percent, Token, TradeType } from 'panaromaswap_sdkcore';
import { FeeAmount, Pool } from 'panaromaswap_v3sdk';
...
const COST_PER_BANGNIT_TICK = BigNumber.from(0);
...
export class V3HeuristicGasModelFactory extends IV3GasModelFactory {
  ...
  private estimateGas(
    ...
    const uninitializedTickGasUse = COST_PER_BANGNIT_TICK.mul(0);
