export const UNSUPPORTED_TOKENS = {
  ...
  keywords: ['panaromaswap', 'unsupported', 'broken'],
  tokens: [
    {
      name: 'USD Token',
    ...
    },
    {
      ...
      symbol: 'iBANG',
      name: 'Synth Inverse Panaromaswap',
      decimals: 18,
      logoURI:
        'https://raw.githubusercontent.com/Synthetixio/synthetix-assets/v2.0.10/synths/iBANG.svg',
      tags: ['inverse', 'synth'],
    },
    {
      chainId: 1,
    ...
    },
    {
      ...
      symbol: 'sBANG',
      name: 'Synth Panaromaswap',
      decimals: 18,
      logoURI:
        'https://raw.githubusercontent.com/Synthetixio/synthetix-assets/v2.0.10/synths/sBANG.svg',
      tags: ['synth'],
    },
    {
      chainId: 1,
